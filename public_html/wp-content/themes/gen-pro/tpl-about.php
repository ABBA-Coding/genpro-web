        ...
        <div class="row align-items-center">
            <div class="col-sm-8">
                <div class="about-header-content">
                    <div class="logo sm-none">
                        <img src="<?= $banner['logo_url'] ?>" width="180" height="70" alt="GenPro">
                    </div>
                    <h2><?= $banner['title'] ?></h2>
                    <p><?= $banner['text'] ?></p>
                </div>
            ...
            <div class="col-sm-4">
                <img class="about-header-content-img" src="<?= $banner['img_url'] ?>" alt="">
            </div>
        </div>
    </div>
</section>
<section class="run-text-section">
    <p class="bg-run-text">
        <?php for ($i = 0; $i < 2; $i++) : ?>
            <span><?= $slider['text_bg'] ?></span>
        <?php endfor; ?>
    </p>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-7 mx-auto">
                <div class="about-slick-content">
                    <div class="fly-top-left ">
                        <div class="info-fly-block">
                            <div class="fly-content">
                                <h4><?= $slider['block_1']['title'] ?></h4>
                                <p><?= $slider['block_1']['text'] ?></p>
                            </div>
                            <div class="icon">
                                <img src="<?= $slider['block_1']['icon']['url'] ?>" width="<?= $slider['block_1']['icon']['width'] ?>" height="<?= $slider['block_1']['icon']['height'] ?>" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="fly-top-right">
                        <div class="info-fly-block">
                            <div class="fly-content">
                                <h4><?= $slider['block_3']['title'] ?></h4>
                                <p><?= $slider['block_3']['text'] ?></p>
                            </div>
                            <div class="icon">
                                <img src="<?= $slider['block_3']['icon']['url'] ?>" width="<?= $slider['block_3']['icon']['width'] ?>" height="<?= $slider['block_3']['icon']['height'] ?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="about-slick">
                    <?php foreach ($slider['list'] as $key => $item): ?>
                        <div class="about-slick-item">
                            <img src="<?= $item['img_url'] ?>" class="d-block w-100" alt="...">
                        </div>
                    <?php endforeach; ?>
                </div>
                <div class="about-slick-content">

                    <div class="fly-bottom-left">
                        <div class="info-fly-block">
                            <div class="fly-content">
                                <h4><?= $slider['block_2']['title'] ?></h4>
                                <p><?= $slider['block_2']['text'] ?></p>
                            </div>
                            <div class="icon">
                                <img src="<?= $slider['block_2']['icon']['url'] ?>" width="<?= $slider['block_2']['icon']['width'] ?>" height="<?= $slider['block_2']['icon']['height'] ?>" alt="">
                            </div>
                        </div>
                    </div>

                    <div class="fly-bottom-right">
                        <div class="info-fly-block">
                            <div class="fly-content">
                                <h4><?= $slider['block_4']['title'] ?></h4>
                                <p><?= $slider['block_4']['text'] ?></p>
                            </div>
                            <div class="icon">
                                <img src="<?= $slider['block_4']['icon']['url'] ?>" width="<?= $slider['block_4']['icon']['width'] ?>" height="<?= $slider['block_4']['icon']['height'] ?>" alt="">
        ...
        <div class="row">
            <div class="col-sm-9">
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <img class="about-gallery-section-img h-300" src="<?= $gallery['img_1'] ?>" alt="">
                    </div>
                    <div class="col-sm-5">
                        <img class="about-gallery-section-img h-300" src="<?= $gallery['img_2'] ?>" alt="">
                    </div>
                </div>
            </div>
            <div class="col-sm-3">

                <img class="about-gallery-section-img" src="<?= $gallery['img_3'] ?>" alt="">
            </div>
        </div>
        <div id="carouselExampleIndicators" class="carousel slide gen-carousel p-0" data-ride="carousel">
            <ol class="carousel-indicators">
                <?php foreach ($gallery['list'] as $key => $item): ?>
