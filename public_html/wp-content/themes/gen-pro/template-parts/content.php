...
<div class="col">
	<div class="gen-card">
		<div class="card">
			<img src="<?= get_the_post_thumbnail_url() ?>" class="card-img-top <?= (get_post_type() == 'news') ? 'img-fluid p-0' : '' ;?>" alt="<?= the_title()?>">
			<div class="card-body">
				<h5 class="card-title"><?= the_title() ?></h5>
				<p class="card-text">
					<?= mb_strimwidth(get_the_excerpt(), 0, 130, '...') ?>
				</p>
				<a href="<?= get_post_permalink() ?>" class="btn gen-btn">
					<?=
					$content['text_go_to'] ?>
					<span class="arrow">
